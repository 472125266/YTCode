//
//  Combination_ProvideViewController.h
//  房贷计算器APP－YT
//
...
@interface Combination_ProvideViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
//**组合贷款页面上的TableVIew**//
@property (strong, nonatomic) IBOutlet UITableView *Combination_TableView;

//**为了防止是4s/5s打开，其页面上的TableView的顶部会根据软件盘的弹起而自动前缩的一个约束值**//
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *Combination_TableView_TopLayoutRange;


//**将单元格上的textField传来本页面，并用创建的对象接收//
//**页面上的第一个TextField(公积金贷款金额(万元))**//
@property (strong, nonatomic) UITextField *textField_1;
//**页面上的第二个TextField(公积金贷款利率(%))**//
@property (strong, nonatomic) UITextField *textField_2;
//**页面上的第三个TextField(商业贷款金额(万元))**//
@property (strong, nonatomic) UITextField *textField_3;
//**页面上的第四个TextField(商业贷款利率(%))**//
@property (strong, nonatomic) UITextField *textField_4;
//**页面上的第五个TextField(商业贷款利率折扣(倍数))**//
@property (strong, nonatomic) UITextField *textField_5;
//**页面上的第六个TextField(贷款期限(年))**//
@property (strong, nonatomic) UITextField *textField_6;
//**页面上的第七个TextField(还款日期(年月))**//
@property (strong, nonatomic) UITextField *textField_7;
...
//**公积金贷款金额**//
@property(nonatomic,assign)double CPF_LoanMoney;
//**公积金贷款利率**//
@property(nonatomic,assign)double CPF_LoanInterest;
//**商业贷款金额**//
@property(nonatomic,assign)double Trade_LoanMoney;
//**商业贷款利率**//
@property(nonatomic,assign)double Trade_LoanInterest;
//**商业贷款利率折扣**//
@property(nonatomic,assign)double Trade_InterestRateDiscount;
//**贷款期限**//
...
//**处理的数据**//
//**公积金每月还款(等额本息)/本金(等额本金)**//
@property(nonatomic,assign)double CPF_EveryMonthMoney;
//**商业贷款每月还款(等额本息)/本金(等额本金)**//
@property(nonatomic,assign)double Trade_EveryMonthMoney;
//**公积金月利率**//
@property(nonatomic ,assign)double CPF_EveryMonthDouble;
//**商业月利率**//
@property(nonatomic ,assign)double Trade_EveryMonthDouble;
//**公积金剩余金额**//
@property(nonatomic,assign)double CPF_surplusMoney;
//**商业剩余金额**//
@property(nonatomic,assign)double Trade_surplusMoney;
//**公积金每期还款利息**//
@property(nonatomic,assign)double CPF_EveryLoanInterest;
//**公积金每期还款利息**//
@property(nonatomic,assign)double Trade_EveryLoanInterest;
//**公积金每期还款本金(本息)/每期还款总额(本金)**//
@property(nonatomic,assign)double CPF_EveryMonthInterest;
//**商业贷款每期还款本金(本息)/每期还款总额(本金)**//
@property(nonatomic,assign)double Trade_EveryMonthInterest;
