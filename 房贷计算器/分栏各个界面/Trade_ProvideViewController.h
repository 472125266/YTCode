...
@interface Trade_ProvideViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>

//**商业贷款页面上的TableVIew**//
@property (strong, nonatomic) IBOutlet UITableView *Trade_tableView;

//**为了防止是4s/5s打开，其页面上的TableView的顶部会根据软件盘的弹起而自动前缩的一个约束值**//
@property (strong, nonatomic) IBOutlet NSLayoutConstraint *Trade_TableView_TopLayoutRange;
...
//**贷款利率折扣**//
@property(nonatomic,assign)double InterestRateDiscount;
